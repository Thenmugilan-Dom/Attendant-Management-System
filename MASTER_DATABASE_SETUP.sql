...
CREATE TABLE IF NOT EXISTS teacher_subjects (
  ...
  day_order INTEGER CHECK (day_order >= 1 AND day_order <= 10),
  start_time TIME,
  end_time TIME,
...
-- ───────────────────────────────────────────────────────────────────────
-- Day Order: tables and functions (inserted from migrations/002_day_order_settings.sql)
-- ───────────────────────────────────────────────────────────────────────
...
-- Add day_order column to teacher_subjects if missing (keeps compatibility)
DO $$
BEGIN
  IF NOT EXISTS (
